...
% small sample size, extrapolating the data reveals serious trends. 
    ...
    % Flaws in the design of the experiment
    % Might bias in favor of those who had extra guidance, or those who had access to the the instructor. 
    % Very clearly a potential source of bias, that could have skewed the results in favor of increased guidance. There is also reason to believe otherwise. If it was a problem inherent to the design, then it should affect all groups more-or-less evenly, which allows us to extract the underlying signal from the noise. 
